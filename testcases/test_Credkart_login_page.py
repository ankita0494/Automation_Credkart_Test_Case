...
class Test_User_Profile :
    ...
    excel_path = r"C:\Users\Admin\PycharmProjects\PythonProject4\Test_data\Credkart_Test_Data.xlsx"
    ...
    @pytest.mark.order(4)
    def test_Credkart_login_excel_ddt_010(self):
        ...
        self.log.info(f"Testcase test_Credkart_login_excel_ddt_010 is completed")
